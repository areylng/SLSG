...
def parse_arguments(data_type,pro):
    ...
    parser.add_argument(
        '--anomaly_maps_dir',
        default='/home/wangyizhuo/Documents/PY_CODE/lunwen/test_pretrain_NEW/log_metris_OO/model_name/',
        #required=True,
...
def EVAL_ME(data_type='d',pro=6):
    ...
    print(localization_results['auc_spro']['mean'])
    print(localization_results['auc_spro']['logical_anomalies'])
    print(localization_results['auc_spro']['structural_anomalies'])
