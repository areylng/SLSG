...
def get_1d_sincos_pos_embed_from_grid(embed_dim, pos):
    ...
    return emb
#aa = np.float32(get_2d_sincos_pos_embed(64, 128))#.reshape(128,128,64).transpose(2,0,1)
aa = torch.from_numpy(np.float32(get_2d_sincos_pos_embed(64, 128)).reshape(128,128,64).transpose(2,0,1)).cuda()
print()
